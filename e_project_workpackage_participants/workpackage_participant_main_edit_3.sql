...
select 
   'prm2_sub_id' as name,
    ...
    TRUE as readonly,
    6 AS width,
    (SELECT  c.prm2_sub_name FROM project_workpackage_participants as p
...
SELECT 
    ...
    'select'                       as type,
    4                              AS width,
    (SELECT workpackage_participant_role FROM project_workpackage_participants WHERE workpackage_participant_id=$workpackage_participant_id) AS value,
...
SELECT 
    ...
    'select'                       as type,
    4                              AS width,
    (SELECT workpackage_participant_status FROM project_workpackage_participants WHERE workpackage_participant_id=$workpackage_participant_id) AS value,
