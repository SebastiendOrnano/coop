...
FROM project_participants_worksequence as e
LEFT JOIN (SELECT worksequence_id, worksequence_name FROM project_worksequences ) as t
...
WHERE e.worksequence_id = $worksequence_id AND e.worksequence_participant_status= 'active';
