...
SELECT
    ...
    ELSE    '[Chat](/c_workspaces/workchat_form_4.sql?workspace_participant_id='||workspace_participant_id||'&workspace_id='||workspace_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Delete](/c_workspaces/workspace_participant_delete_alert1_4.sql?workspace_participant_id='||workspace_participant_id||'&workspace_id='||workspace_id||')' END AS View
