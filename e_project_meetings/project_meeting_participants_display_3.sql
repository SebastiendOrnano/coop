...
select 
    '/e_project_meetings/project_meeting_participant_form1_3.sql?project_meeting_id='||$project_meeting_id       as link,
   'Inscrire une personne physique (PRM1)'       as description,
    'copy-plus'                                  as icon,
    'green'                                      as color;

select 
    '/e_project_meetings/project_meeting_participant_form2_step1_3.sql?project_meeting_id='||$project_meeting_id       as link,
...
SELECT
    ...
    THEN m.prm1_email
    END                                    AS Mail,
    '[remove](/e_project_meetings/project_meeting_participant_remove_0.sql?project_meeting_participant_id='||p.project_meeting_participant_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[change role](/e_project_meetings/project_meeting_participant_edit_3.sql?project_meeting_participant_id='||p.project_meeting_participant_id||')'  as view
