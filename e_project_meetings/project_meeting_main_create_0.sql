...
THEN '/e_project_meetings/project_meeting_main_display_4.sql?project_id='||$project_id
ELSE '/e_project_meetings/project_meeting_main_display_3.sql?project_id='||$project_id
END;
...
SET project_meeting_id = (SELECT MAX(project_meeting_id) FROM project_meetings WHERE project_meeting_title=:project_meeting_title AND project_meeting_date=:project_meeting_date);
