...
select 
    ...
    'sm'     as size;
select 
    '/a_info/section_form_5.sql'     as link,
    'orange' as outline,
...
SELECT       
   ...
   section_publication_status  as Publication,
   section_title               AS Titre,
 
   '[Edit](/a_info/section_edit_5.sql?section_id=' || section_id || ')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Delete](/a_info/section_delete_5.sql?section_id=' || section_id|| ')'    AS View
FROM info_sections
WHERE section_publication_status !='archived'
