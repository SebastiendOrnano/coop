...
select 
    '/e_project_stats/stat_project_workhours_csv_0.sql?project_id='||$project_id       as link,
    'télécharger le total des heures par sequence'                 as description,
    'download'                                          as icon,
    'blue'                                                as color;
select 
    'stat_project_participants_workhours_csv_0.sql?project_id='||$project_id        as link,
