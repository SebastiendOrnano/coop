...
select 
    '/c_meetings/meeting_resa_display_4.sql'    as link,
...
select 
    '/c_meetings/meeting_archive_display_4.sql'       as link,
    'Liste des événements archivés'                   as description,
    'archive'                                         as icon,
    'yellow'                                          as color;

select 
    '/c_meetings/meeting_archive_display_4.sql'       as link,
    'Liste des événements terminés'                   as description,
...
SELECT
    ...
    THEN 'Entrée libre&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[View](/c_meetings/meeting_main_poster_1.sql?event_id='||e.event_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Edit](/c_meetings/meeting_main_edit_4.sql?event_id='||e.event_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Delete](/c_meetings/meeting_main_delete_alert_4.sql?event_id='||e.event_id||')' 
