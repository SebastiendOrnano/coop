...
select 
    '/e_project_meetings/project_meeting_main_form_4.sql?project_id='||$project_id          as link,
    'Création d''une nouvelle réunion'          as description,
    'calendar-time'                                    as icon,
    'yellow'                                   as color;
select 
    '/e_project_meetings/project_meeting_archive_display_4.sql?project_id='||$project_id          as link,
...
SELECT
   ...
   '[View](/e_project_meetings/project_meeting_main_view_4.sql?project_meeting_id='||e.project_meeting_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   [Participants](/e_project_meetings/project_meeting_participants_display_4.sql?project_meeting_id='||e.project_meeting_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   [Delete](/e_project_meetings/project_meeting_main_delete_0.sql?project_meeting_id='||e.project_meeting_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' 
    ||CASE
    ...
    THEN'[Edit](/e_project_meetings/project_meeting_main_edit_4.sql?project_meeting_id='||e.project_meeting_id||')' 
    ELSE ''
    END   AS View
