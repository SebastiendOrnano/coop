...
SET workpackage_participant_id = SELECT MAX(workpackage_participant_id) FROM project_participants_workpackage WHERE workpackage_id=$workpackage_id;
SET prm2_sub_id = SELECT prm2_sub_id from project_participants_workpackage where workpackage_participant_id = $workpackage_participant_id
