...
select 
    '/e_project_participants/project_participant_main_form1_4.sql?project_id='||$project_id             as link,
    'Ajout d''un nouveau participant (prm1) '                  as description,
    'user-plus'                                      as icon,
    'green'                                         as color;
select 
    '/e_project_participants/project_participant_main_form2_4.sql?project_id='||$project_id             as link,
    'Ajout d''un nouveau participant (prm2_sub)'                  as description,
    'user-plus'                                      as icon,
    'orange'                                         as color;
select 
    '/e_project_participants/project_participant_main_form3_step1_4.sql?project_id='||$project_id             as link,
    'Ajout d''un nouvel participant (prm2_sub_employees)'                  as description,
    'user-plus'                                      as icon,
    'red'                                         as color;
select 
    '/e_project_participants/project_participant_main_form4_4.sql?project_id='||$project_id             as link,
    'Ajout d''un groupe'                  as description,
    'user-plus'                                      as icon,
    'blue'                                         as color;
select 
    '/e_project_participants/project_participant_archive_display_4.sql?project_id='||$project_id as link,
