...
select 
    '/c_workspaces/workspace_participant_display_3.sql?workspace_id='||$workspace_id  as link,
...
select 
    ...
    'L'     as size;
select 
    '/c_workspaces/workchat_form_3.sql?workspace_id='||$workspace_id    as link,
    'green'                              as color,
    TRUE                                 as important,
...
SELECT       -- NOTE: the dots join values from the forum_topics and forum_messages tables
    ...
    END    as destinataire,
    '[Discussion](/c_workspaces/workchat_message_display_3.sql?topic_id='||t.topic_id||'&workspace_id='||$workspace_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Close](/c_workspaces/workchat_close_0.sql?topic_id='||t.topic_id||'&workspace_id='||$workspace_id||')'    AS View
