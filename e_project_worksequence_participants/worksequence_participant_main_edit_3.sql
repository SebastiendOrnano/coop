...
select 
   'prm2_sub_id' as name,
    ...
    TRUE as readonly,
    6 AS width,
    (SELECT  c.prm2_sub_name FROM project_worksequence_participants as p
...
SELECT 
    ...
    'select'                       as type,
    4                              AS width,
    (SELECT worksequence_participant_role FROM project_worksequence_participants WHERE worksequence_participant_id=$worksequence_participant_id) AS value,
...
SELECT 
    ...
    'select'                       as type,
    4                              AS width,
    (SELECT worksequence_participant_status FROM project_worksequence_participants WHERE worksequence_participant_id=$worksequence_participant_id) AS value,
