...
FROM prm1 as i
LEFT JOIN (SELECT worksequence_id, prm1_id FROM project_participants_worksequence) as p
...
WHERE i.prm1_id=:prm1_id AND p.project_id = $project_id AND s.worksequence_status='active' ;