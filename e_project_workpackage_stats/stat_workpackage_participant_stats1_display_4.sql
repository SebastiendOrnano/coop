...
select 
    'title'     as component,
    'Analyse de la réprtition des temps de travail pour le projet :   '||$project_name||' / '||$workpackage_name    as contents,
    1          as level;
...
select 
    ...
    'red'                            as value_color,
    4                                 as size,
    $project_name||' / '||$workpackage_name||' :   Nb d''heures prévues'                as description,
...
select 
   ...
   $duration_actual/60                 as value,
    ...
    4                                 as size,
   $project_name||' / '||$workpackage_name||' :   Nb d''heures réalisées'                as description,
    'shovel-pitchforks'                       as icon,
    'green'                           as icon_color,
