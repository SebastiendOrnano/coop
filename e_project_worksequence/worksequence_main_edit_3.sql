...
SELECT 
    ...
    3 as width,
    TRUE                     as required,
    (select worksequence_status  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
...
SELECT 
    ...
    'select'                 as type,
    3 as width,
    (select worksequence_type  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
    'Choisir un stype dans la liste...' as  empty_option,
    json_group_array(json_object('label',i.choice_label, 'value', i.choice_value))  AS options
    FROM choices_items AS i
    LEFT JOIN (select choice_category_id, choice_category_name from choices_categories)  AS c 
...
SELECT
    ...
    (select worksequence_summary  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value;

SELECT
    'worksequence_todo' as name,
    'textarea' as type,
    'Travaux à faire...' as description,
    (select worksequence_todo  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
...
select 
    ...
    12 AS width,
    TRUE as searchable,
    (select room_id FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
...
SELECT 
    ...
    'date'                      as type,
    6                           AS width,
    (select worksequence_start_date_scheduled  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
...
SELECT 
    ...
    'date'                      as type,
    6                           AS width,
    (select worksequence_start_date_actual  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
   (select regex_value from regex where regex_name='date')         as pattern,
   (select regex_description from regex where regex_name='date')   as description;
...
SELECT 
    ...
    'select'                      as type,
    6                           AS width,
    (select worksequence_start_hour_scheduled  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
...
SELECT 
    ...
    'select'                      as type,
    6                           AS width,
    (select worksequence_start_hour_actual  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
    'Choisir une heure dans la liste...'    as empty_option,
    json_group_array(json_object('label',i.choice_label, 'value', i.choice_value))  AS options
    FROM choices_items AS i
    LEFT JOIN (select choice_category_id, choice_category_name from choices_categories)  AS c 
...
SELECT 
    ...
    'select'                      as type,
    6                            AS width,
    (select worksequence_end_hour_scheduled FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
    'Choisir une heure dans la liste...'    as empty_option,
    json_group_array(json_object('label',i.choice_label, 'value', i.choice_value))  AS options
    FROM choices_items AS i
    LEFT JOIN (select choice_category_id, choice_category_name from choices_categories)  AS c 
...
SELECT 
    ...
    'select'                      as type,
    6                          AS width,
    (select worksequence_end_hour_actual  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
    'Choisir une heure dans la liste...'    as empty_option,
    json_group_array(json_object('label',i.choice_label, 'value', i.choice_value))  AS options
    FROM choices_items AS i
    LEFT JOIN (select choice_category_id, choice_category_name from choices_categories)  AS c 
...
SELECT 
    ...
    'select'                      as type,
    (select worksequence_duration_scheduled  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,
    'heures'                    as suffix,
        6                         AS width,
    'Choisir une heure dans la liste...'    as empty_option,
    json_group_array(json_object('label',i.choice_label, 'value', i.choice_value))  AS options
...
SELECT 
    ...
    (select worksequence_completion_percentage  FROM project_worksequence WHERE worksequence_id = $worksequence_id) as value,   
    'number'                                 as type,
    '%'                                      as suffix,
    4                          AS width;
