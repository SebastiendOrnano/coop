...
select 
    ...
    'Gestion des partcipants du projet : '||$project_name as title;
select 
    '/e_project_participants/project_participant_main_form1_3.sql?project_id='||$project_id             as link,
    'Ajout d''un nouveau participant (prm1) '                  as description,
    'user-plus'                                      as icon,
    'green'                                         as color;
select 
    '/e_project_participants/project_participant_main_form2_3.sql?project_id='||$project_id             as link,
    'Ajout d''un nouveau participant (prm2_sub)'                  as description,
    'user-plus'                                      as icon,
    'orange'                                         as color;
select 
    '/e_project_participants/project_participant_main_form3_step1_3.sql?project_id='||$project_id             as link,
    'Ajout  d''un nouvel participant (prm2_sub_employees)'                  as description,
    'user-plus'                                      as icon,
    'red'                                         as color;
select 
    '/e_project_participants/project_participant_main_form4_3.sql?project_id='||$project_id             as link,
    'Ajout d''un groupement (prm3)'                  as description,
    'user-plus'                                      as icon,
    'blue'                                         as color;

select  
    '/e_project_participants/project_participant_csv_email_0.sql?project_id='||$project_id as link,
...
SELECT
   ...
   '['|| c.prm2_sub_name ||'](/d_prm2_sub/prm2_sub_main_view_3.sql?prm2_sub_id='||c.prm2_sub_id||')' as Corporate,
    ...
    '[Edit](/e_project_participants/project_participant_main_edit_3.sql?project_participant_id='||p.project_participant_id||'&project_id='||$project_id||') &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Archive](/e_project_participants/project_participant_main_archive_0.sql?project_participant_id='||p.project_participant_id||'&project_id='||$project_id||') &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  [Remove](/e_project_participants/project_participant_main_remove_0.sql?project_participant_id='||p.project_participant_id||'&project_id='||$project_id||')'    AS View
