...
select 
    '/e_project_buildings/building_main_form_3.sql?project_id='||$project_id     as link,
...
SELECT
   ...
   '[Map](/e_project_buildings/building_map_display_3.sql?building_id='||building_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   [view](/e_project_buildings/building_main_profile_3.sql?building_id='||building_id||')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   [rooms](/e_project_building_rooms/room_main_display_3.sql?building_id='|| building_id|| ')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   [Edit](/e_project_buildings/building_main_edit_3.sql?building_id=' || building_id ||')'    AS View
