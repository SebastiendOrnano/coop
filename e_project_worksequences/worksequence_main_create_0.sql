...
(
    SELECT
        CASE
            ...
            THEN '/e_project_worksequences/worksequence_main_create_alert1_1.sql?workpackage_id='||$workpackage_id||'&suffix_role='||$suffix_role
            ELSE ''
        END
);
...
INSERT INTO project_worksequences
(
	workpackage_id,
	worksequence_name,
	worksequence_status,
