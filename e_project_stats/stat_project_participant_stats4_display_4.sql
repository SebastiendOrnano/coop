...
SELECT
    '/e_project_stats/stat_project_participant_stats1_form1_4.sql?project_id='||$project_id   as link,
    'Télécharger les données par participant'                      as description,
    'download'                                     as icon,
    'green'                                         as color;
SELECT
    '/e_project_stats/stat_project_participant_stats1_form2_4.sql?project_id='||$project_id   as link,
    'Télécharger les données par entrerprise'                      as description,
    'download'                                     as icon,
    'yellow'                                         as color;
SELECT
    '/e_project_stats/stat_project_participant_stats1_form3_step1_4.sql?project_id='||$project_id   as link,
    'Télécharger les données pour un employé d''une entreprise'                      as description,
    'download'                                     as icon,
    'red'                                         as color;
SELECT
    '/e_project_stats/stat_project_participant_stats1_form4_4.sql?project_id='||$project_id   as link,
